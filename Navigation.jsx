    ...
    <Tab.Navigator initialRouteName="contactos">
      ...
      options={{
        ...
        tabBarIcon:({colors,size})=>(
            <MaterialCommunityIcons name="account-box" size={30} color="black" />
        )
      }}
   
      />
      <Tab.Screen name="destacados" component={DestacadoScreen} 
         options={{
            tabBarLabel:'Contactos',
            headerShown:false,
            tabBarIcon:({colors,size})=>(
                <MaterialCommunityIcons name="star-box-outline" size={30} color="black" />
